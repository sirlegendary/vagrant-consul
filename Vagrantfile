...
Vagrant.configure(2) do |config|
  ...
  #       shell.args = [i, "10.0.0.#{i + 4}", CONSUL_CLIENT_NUMER]
  #       shell.privileged = true
  #     end
  #     consul.vm.post_up_message = "login to consul on port 8500"
  #     # Expose the consul api and ui to the host
  #     consul.vm.network "forwarded_port", guest: 8500, host: 8500, auto_correct: true, host_ip: "127.0.0.#{i + 4}"
  #     consul.vm.network "forwarded_port", guest: 8443, host: 8443, auto_correct: true, host_ip: "127.0.0.#{i + 4}"
  #     consul.vm.network "private_network", ip: "10.0.0.#{i + 4}", virtualbox__intnet: "consul"
  #   end
  # end
end
